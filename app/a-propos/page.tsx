...
const page = () => {
    return (
        <div id="Apropos" className="flex flex-col items-center justify-center pt-20 px-10 gap-20">
            <h1 className="font-semibold text-zinc-700 text-5xl lg:text-7xl pb-20">
                Compétences{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-red-400"> & </span>
                outils
            </h1>
